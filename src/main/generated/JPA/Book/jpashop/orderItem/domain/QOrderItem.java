...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    private static final long serialVersionUID = -253709805L;
    ...
    public final JPA.Book.jpashop.item.domain.QItem item;
    ...
    public QOrderItem(Class<? extends OrderItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new JPA.Book.jpashop.item.domain.QItem(forProperty("item")) : null;
